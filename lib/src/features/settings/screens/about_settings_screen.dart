    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // 4. Replay Setup & Onboarding Wizard Card
          Card(
            child: Padding(
              padding: const EdgeInsets.all(16.0),
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  Text(
                    'Re-launch the initial interactive setup walkthrough to check permissions, adjust units, and review features.',
                    style: theme.textTheme.bodySmall?.copyWith(
                      color: colorScheme.onSurfaceVariant,
                      height: 1.3,
                    ),
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: const Text('Replay Setup Walkthrough'),
                    ),
                  ),
                ],
              ),
